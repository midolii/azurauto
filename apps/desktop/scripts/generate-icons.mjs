...
const devDockIconContentSize = 896;
...
try {
	...
	await copyFile(resolve(generatedDir, "icon.icns"), resolve(publicDir, "icon.icns"));
	await copyFile(resolve(generatedDir, "icon.ico"), resolve(publicDir, "icon.ico"));
	await copyFile(resolve(generatedDir, "favicon.ico"), resolve(publicDir, "favicon.ico"));
